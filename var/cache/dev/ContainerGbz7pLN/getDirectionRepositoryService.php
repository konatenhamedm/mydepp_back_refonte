...
class getDirectionRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Repository/DirectionRepository.php';

        return $container->privates['App\\Repository\\DirectionRepository'] = new \App\Repository\DirectionRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
