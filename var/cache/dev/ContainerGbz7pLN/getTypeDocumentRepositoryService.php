 ...
 */
class getTypeDocumentRepositoryService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Repository/TypeDocumentRepository.php';

        return $container->privates['App\\Repository\\TypeDocumentRepository'] = new \App\Repository\TypeDocumentRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
