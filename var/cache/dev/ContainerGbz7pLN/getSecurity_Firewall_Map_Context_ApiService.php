...
class getSecurity_Firewall_Map_Context_ApiService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Security/JwtEntryPoint.php';
        ...
        }, 3), new \Symfony\Component\Security\Http\Firewall\ExceptionListener(($container->privates['security.token_storage'] ?? self::getSecurity_TokenStorageService($container)), ($container->privates['security.authentication.trust_resolver'] ??= new \Symfony\Component\Security\Core\Authentication\AuthenticationTrustResolver()), new \Symfony\Component\Security\Http\HttpUtils($a, $a, '{^https?://%s$}i', '{^https://%s$}i'), 'api', new \App\Security\JwtEntryPoint(), NULL, NULL, ($container->privates['monolog.logger.security'] ?? $container->load('getMonolog_Logger_SecurityService')), true), NULL, new \Symfony\Bundle\SecurityBundle\Security\FirewallConfig('api', 'App\\Security\\UserChecker', '.security.request_matcher.NaFk5J1', true, true, 'security.user.provider.concrete.app_user_provider', NULL, 'App\\Security\\JwtEntryPoint', NULL, NULL, ['App\\Security\\JwtAuthenticator'], NULL, NULL));
    }
}
