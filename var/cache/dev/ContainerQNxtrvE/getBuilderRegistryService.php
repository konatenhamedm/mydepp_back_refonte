...
class getBuilderRegistryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->set('default', new \Endroid\QrCode\Builder\Builder(new \Endroid\QrCode\Writer\PngWriter(), [], false, '', new \Endroid\QrCode\Encoding\Encoding('UTF-8'), \Endroid\QrCode\ErrorCorrectionLevel::Low, 150, 5, \Endroid\QrCode\RoundBlockSizeMode::Margin));
