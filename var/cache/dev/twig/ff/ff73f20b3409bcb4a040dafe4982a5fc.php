...
class __TwigTemplate_6b0fdb9ab891112206706568beed6bdb extends Template
{
...
";
    ...
    public function block_fieldset_form_row(array $context, array $blocks = []): iterable
    {
        ...
        $context["widget_attr"] = [];
        // line 43
        if ((($tmp = (isset($context["help"]) || array_key_exists("help", $context) ? $context["help"] : (function () { throw new RuntimeError('Variable "help" does not exist.', 43, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 44
...
", "bootstrap_4_horizontal_layout.html.twig", "/Volumes/konate/ANVOH/mydeep_admin/backend/vendor/symfony/twig-bridge/Resources/views/Form/bootstrap_4_horizontal_layout.html.twig");
    }
}
