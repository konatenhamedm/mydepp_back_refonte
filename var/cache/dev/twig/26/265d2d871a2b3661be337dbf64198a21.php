...
class __TwigTemplate_a5d5494d48165334bfc67f72bdd0d30a extends Template
{
...
";
    ...
    ";
        ...
        <div class=\"sf-toolbar-info-group\">
            ...
            ";
            // line 95
            if ((CoreExtension::getAttribute($this->env, $this->source, ($context["collector"] ?? null), "runner", [], "any", true, true, false, 95) &&  !(null === CoreExtension::getAttribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 95, $this->source); })()), "runner", [], "any", false, false, false, 95)))) {
                // line 96
                yield "                <div class=\"sf-toolbar-info-piece sf-toolbar-info-runner\">
                    <b>Runner</b>
                    <span>";
                // line 98
                yield $this->extensions['Symfony\Bundle\WebProfilerBundle\Profiler\CodeExtension']->abbrClass($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 98, $this->source); })()), "runner", [], "any", false, false, false, 98), "html", null, true));
                yield "</span>
                </div>
            ";
            }
...
";
    ...
    ";
        // line 182
        if ((CoreExtension::getAttribute($this->env, $this->source, ($context["collector"] ?? null), "runner", [], "any", true, true, false, 182) &&  !(null === CoreExtension::getAttribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 182, $this->source); })()), "runner", [], "any", false, false, false, 182)))) {
            // line 183
            yield "        <div class=\"metrics\">
            <div class=\"metric\">
                <span class=\"value\">";
            // line 185
            yield $this->extensions['Symfony\Bundle\WebProfilerBundle\Profiler\CodeExtension']->abbrClass($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 185, $this->source); })()), "runner", [], "any", false, false, false, 185), "html", null, true));
            yield "</span>
...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "@WebProfiler/Collector/config.html.twig", "/Volumes/konate/ANVOH/mydeep_admin/backend/vendor/symfony/web-profiler-bundle/Resources/views/Collector/config.html.twig");
    }
}
