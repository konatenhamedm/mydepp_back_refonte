...
class StatutJuridique
{
     ...
     */
    #[ORM\OneToMany(targetEntity: Etablissement::class, mappedBy: 'statutJuridique')]
    ...
    public function addEtablissement(Etablissement $etablissement): static
    {
        if (!$this->etablissements->contains($etablissement)) {
            ...
            $etablissement->setStatutJuridique($this);
        }
    ...
    public function removeEtablissement(Etablissement $etablissement): static
    {
        if ($this->etablissements->removeElement($etablissement)) {
            if ($etablissement->getStatutJuridique() === $this) {
                $etablissement->setStatutJuridique(null);
            }
        }
