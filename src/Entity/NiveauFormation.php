...
class NiveauFormation
{
     ...
     */
    #[ORM\OneToMany(targetEntity: Etablissement::class, mappedBy: 'responsableNiveauFormation')]
    ...
    public function addEtablissement(Etablissement $etablissement): static
    {
        if (!$this->etablissements->contains($etablissement)) {
            ...
            $etablissement->setResponsableNiveauFormation($this);
        }
    ...
    public function removeEtablissement(Etablissement $etablissement): static
    {
        if ($this->etablissements->removeElement($etablissement)) {
            if ($etablissement->getResponsableNiveauFormation() === $this) {
                $etablissement->setResponsableNiveauFormation(null);
            }
        }
