                    ...
                    try {
                        ...
                        if ($existingPerson) {
                            ...
                            if ($rowData['num'] != null && $rowData['dateEnregistre'] != null && $rowData['nom'] != null && $rowData['numId'] != null && $rowData['dateNaissance'] != null && $rowData['lieuNaissance'] != null && $rowData['sexe'] != null && $rowData['nationalite'] != null && $rowData['dateCommission'] != null) {
                                ...
                                $personne->setDateNaissance(new \DateTime(strval($rowData['dateNaissance'])));

                                $personne->setDateValidation(new \DateTime(strval($rowData['dateCommission'])));

                                $personne->setCreatedAtValue(new \DateTime(strval($rowData['dateEnregistre'])));
