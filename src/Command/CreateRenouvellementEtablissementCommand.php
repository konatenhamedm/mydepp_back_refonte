...
#[AsCommand(
    name: 'app:update-renouvellement-etablissement',
    description: 'Met à jour automatiquement les renouvellements de contrat.'
)]
class CreateRenouvellementEtablissementCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        try {
            $result = $this->renouvellementService->updateDataEtablissement();
